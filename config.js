...
module.exports = {
  ...
  SESSION_ID: process.env.SESSION_ID || "izumi~y5u0pcyK",
  MENU_URL: process.env.MENU_URL || "https://i.imgur.com/cO0TZJv.jpeg",
  CAPTION: process.env.CAPTION || "🤎ＵＤ - Ａｉ- ＢＯＴ🤎",
  READ_MSG: toBool(process.env.READ_MSG),
  OWNER_NAME: process.env.OWNER_NAME || "UMAR",
  BOT_NAME: process.env.BOT_NAME || "UD",
  SUDO: process.env.SUDO || null,
  LANG: process.env.LANGUAGE === undefined ? 'EN' : process.env.LANGUAGE.toUpperCase(),
  STICKER_PACKNAME: process.env.STICKER_PACKNAME || "🤎ＵＤ - Ａｉ- ＢＯＴ🤎",
  AUDIO_DATA: process.env.AUDIO_DATA || "Eʏᴘᴢ;Iᴢᴜᴍɪ-ᴠ3;https://i.imgur.com/cO0TZJv.jpeg",
  PROCESSNAME: process.env.PROCESSNAME || "UD-AI",
  AUTHOR: process.env.AUTHOR || "UMAR",
